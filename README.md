...
La aplicación permite consultar y visualizar personajes de la serie Rick and Morty, mostrando información obtenida desde la API oficial.

El desarrollo se enfocó en:
- Separación clara de componentes
- Código legible y mantenible
- Uso de tipado con TypeScript
